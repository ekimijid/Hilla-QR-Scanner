...
import stylesCss from 'themes/qrscannerthema/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_qrscannerthema_componentCss']) {
    
    document['_vaadintheme_qrscannerthema_componentCss'] = true;
  }
